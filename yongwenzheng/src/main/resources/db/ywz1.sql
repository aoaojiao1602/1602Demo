...
insert  into `coursetb`(`course_id`,`course_status`,`course_weigh`,`kech_id`,`nav_remark`,`navigation_id`,`positions_id`) values (6,1,0,6,'1人',0,1),(7,0,0,7,'1人',0,1),(8,0,0,8,'1人',0,1),(9,0,0,9,'1人',0,1),(10,0,0,7,'1人',0,1),(11,0,0,8,'1人',0,1),(12,0,0,7,'1人',0,1),(13,0,0,8,'1人',0,2),(14,0,0,7,'1人',0,2),(15,0,0,8,'1人',0,2),(16,0,0,7,'1人',0,2),(17,0,0,8,'1人',0,2),(18,0,0,7,'1人',0,2),(19,0,0,8,'1人',0,3),(20,0,0,7,'1人',0,3),(21,0,0,8,'1人',0,3),(22,0,0,7,'1人',0,3),(23,0,0,8,'1人',0,4),(24,0,0,7,'1人',0,4),(25,0,0,8,'1人',0,4),(26,0,0,7,'1人',0,4),(27,0,0,8,'1人',0,4);
...
insert  into `discusscoursetb`(`discusscourse_id`,`discuss_remark`,`discuss_status`,`discuss_weigh`,`kech_id`,`positions_id`,`teacher_id`) values (1,NULL,1,0,1,1,1),(2,NULL,0,0,2,1,2),(3,NULL,0,0,3,2,3);
...
insert  into `module_roles`(`module_roles_id`,`roles_module_id`) values (1,1),(2,1),(3,1),(4,1),(4,3),(5,1),(5,3),(6,1),(6,3),(7,1),(7,3),(8,1),(9,1),(10,1);
...
insert  into `moduletb`(`module_id`,`module_create_time`,`module_last_update_time`,`module_name`,`module_url`,`module_weight`,`parent_id`) values (1,'2018-12-31 13:06:18',NULL,'系统设置','1',1,0),(2,'2018-12-31 13:08:57',NULL,'个人中心管理','2',2,0),(3,'2018-12-31 13:09:13',NULL,'推荐管理','3',3,0),(4,'2019-01-03 09:49:05',NULL,'用户管理','userlist.html',0,1),(5,'2019-01-03 09:50:01',NULL,'角色管理','rolelist.html',5,1),(6,'2019-01-03 09:50:03',NULL,'模块管理','modulelist.html',6,1),(7,'2018-12-31 13:10:22',NULL,'权限管理','7',7,1),(8,'2018-12-31 13:10:39',NULL,'个人中心','8',8,2),(9,'2019-01-03 09:50:21',NULL,'课程推荐管理','kechengtj.html',9,3),(10,'2019-01-03 09:48:00',NULL,'精彩推荐管理','10',0,3);
...
insert  into `permissiontb`(`permission_id`,`permission_last_update_time`,`permission_module`,`permission_name`,`permission_value`) values (1,NULL,'订单管理','Y订单删除','order:deleteOrder'),(2,NULL,'订单管理','Y订单添加','order:addOrder'),(3,NULL,'教师管理','Y教师权限','teacher'),(4,NULL,'学生管理','Y学生权限','student'),(5,NULL,'订单管理','订单管理',NULL),(6,NULL,'教师管理','教师管理',NULL),(7,NULL,'学生管理','学生管理',NULL);
...
insert  into `positiontb`(`position_id`,`position_name`,`position_remark`) values (1,'课程位置一',NULL),(2,'课程位置二',NULL),(3,'课程位置三',NULL),(4,'课程位置四',NULL),(5,'位置五',NULL),(6,NULL,NULL),(7,NULL,NULL),(8,NULL,NULL);
...
insert  into `users_department`(`department_users_id`,`users_department_id`) values (3,3);
...
insert  into `users_roles`(`users_roles_id`,`roles_users_id`) values (1,1),(2,2),(3,3),(4,4),(5,4),(6,4);
