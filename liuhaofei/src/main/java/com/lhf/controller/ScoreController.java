...
public class ScoreController {
	...
	public Object getScoreBycourseId(Integer courseId) {
		List<Score> list = scoreService.getScoreBycourseId(courseId);
		return list;
	}

	/**
	 * 评分标准删除方法 http://localhost:8050/score/deleteScore?scoreId=4
	 * 
