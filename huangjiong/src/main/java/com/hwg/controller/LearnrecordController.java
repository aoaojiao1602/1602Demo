...
public class LearnrecordController {
	 ...
	 * @return
	 */
	@ApiImplicitParams({@ApiImplicitParam(name="kcId",value="课程的id",dataType="String"),
		@ApiImplicitParam(name="xsId",value="学生id",dataType="String"),@ApiImplicitParam(name="zj",value="学习章节",dataType="String")})
	@ApiOperation("查询出当前学生当前课程章节的学习记录")
	@RequestMapping(method=RequestMethod.GET)
	public Object getOneLearnrecord(String kcId,String xsId,String zj) {
		if(zj!=null&&!zj.equals("")) {
			return lservice.getOneLearnrecord(kcId, xsId, zj);
		}else {
			return lservice.querylearnrecord(kcId, xsId);
		}
	...
	public List<String> getHotCourse(){
		List<String> list=lservice.getHotCourse();
		return list;
	}
