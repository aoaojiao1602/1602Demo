package com.lwj.springcloud.websocket;
...
/*		System.out.println("WebSocketSession.getAttributes().get(\"param\")"+session.getAttributes().get("param"));
		...
		allWebSocketSession.put((String)session.getAttributes().get("stuid"), session);
		allWebSocketSession.put((String)session.getAttributes().get("examid"), session);
